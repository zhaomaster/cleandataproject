Background:
The data for this project was from Human Activity Recognition Using Smartphones Dataset at Smartlab (https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip). The experiments have been carried out with a group of 30 volunteers with each person performed 6 activities (WALKING, WALKING_UPSTAIRS, WALKING_DOWNSTAIRS, SITTING, STANDING, LAYING) wearing a smartphone (Samsung Galaxy S II) on the waist. Measurements of 3-axial linear acceleration and 3-axial angular velocity were captured at a constant rate of 50Hz. 70% of the volunteers was selected for generating the training data and 30% the test data. A total of 561 variables were captured in the measurement data set.
...
mean (num that represent the average of each measurement in the feature column for each activity and each subject). 

The intermediate dataset:
The mean and standard deviation measurements extracted from the raw data. There are 66 variables in this dataset. The description of each of the variable can be found in the description of the raw data. The list of the variables:
tBodyAcc-mean()-X
tBodyAcc-mean()-Y
tBodyAcc-mean()-Z
tBodyAcc-std()-X
...
The raw data:
The description of the original 561 variables, 30 subjects, and 6 activities was copied from the feature file from the data source (https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip). 
